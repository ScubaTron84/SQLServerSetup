...
.EXAMPLE 
  Send-EmailStatus -From "SM@Email.com" -To "SM@Email.com" -Subject "This is the subject" -Body "Body of emailk"
.PARAMETER From 
...
#> 
	...
	Send-MailMessage -From $From -To $to -Subject $Subject -Body $body -SmtpServer "exchange.youremailserver.com" -Port 25 -Credential $anonCred
}
...
<# 
  ...
  .EXAMPLE 
  Get-DomainAccountSID -DomainAccountName WorldTest\AUser
  .EXAMPLE 
  Get-DomainAccountSID -DomainAccountName "WorldTest\AUser"
...
<# 
  ...
  .EXAMPLE 
  Get-RequiredWindowsFeature -Hostname ServerWithACoolName -WindowsFeatureName Net-Framework-Core
  returns $true
  .PARAMETER HostName
...
.DESCRIPTION 
	This is mostly a wrapper around the Microsoft commandlet Install-WindowsFeature.  Adds additional error handling and logging.
.PARAMETER WindowsFeatureName
...
<# 
  ...
  .EXAMPLE 
  Format-SQLDisk -DriveLetter 'J' -DriveLabel "Data" -DiskNumber 3 -HostName "TestSQLServer"
...
function Grant-CarbonSecurityPolicy
{
	...
	catch
	{
		...
		Write-Log -Level Error -Message "Failed to Grant Privilege: $Privilege to Identity: $Identity on Host: $HostName,  Error Message $ExceptionMessage."
	}
}
...
.OUTPUTS 
	None
.EXAMPLE 
	Add-LocalGroupMember -Identity "DOMAIN\SomeUser" -LocalGroup "Administrators" -HostName MyFavoriteComputer 
#>
	[cmdletbinding()]
	param
	(
...
.OUTPUTS 
	None
.EXAMPLE 
	Set-ServiceLogin -Identity "DOMAIN\SomeUser" -Password "A SECURE STRING OBJECT SEE PARAMTERS" -ServiceDisplayName "Certificate Propagation" -HostName MyFavoriteComputer 
#>
	[cmdletbinding()]
	param
	(
...
.EXAMPLE 
	Set-DtcNetworkSettings -HostName "NewVSQLInstance"
.PARAMETER HostName
...
.EXAMPLE 
	Set-OSPowerPlan -HostName "NewVSQLInstance" -PowerPlan HighPerformance
.PARAMETER HostName
	Name of the target host
.PARAMETER PowerPlan
