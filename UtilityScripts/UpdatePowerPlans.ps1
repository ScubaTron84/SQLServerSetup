...
Function Get-AllSQLservers
{
	...
	Param
	(
		[String] $SQLOuPath = "OU=SQL,OU=Computer Resources,DC=your,DC=domain,DC=com" 
	)
...
Write-Host "Getting all sql servers from default OU path: OU=SQL,OU=Computer Resources,DC=your,DC=domain,DC=com"
