-- ======================================
/*	
	Description: Configure Always on Alert notifications and operator.
	Author: ScubaTron84
	Company:
	Version: 1.0.0.0
...
USE [msdb]
GO
/* Modify here to set specific Operator*/
DECLARE @DbOperatorName NVarchar(84) = N'DBAdmins'
