...
-- Account information. Replace with the information for your account.
		...
		SET @SMTP_servername = 'exchange.youremailserver.com';
		SET @email_address = @ServerName+'@youremaildomain.com';
        SET @display_name = @ServerName;
		SET @replyto_address = 'DONOT_REPLY_'+@ServerName+'@youremailserver.com'
