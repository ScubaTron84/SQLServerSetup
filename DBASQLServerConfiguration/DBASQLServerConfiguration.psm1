...
Function Confirm-ServiceIsUp
{
	...
	.DESCRIPTION 
		Checks if a service is up, if not, checks every 5 seconds for a status change up to one minute.
	.EXAMPLE 
		Confirm-ServiceIsUp -HostName "NewVSQLInstance" -ServiceName
	.PARAMETER HostName
...
Function Get-SQLVersion
{
	...
	.EXAMPLE 
		Get-SQLVersion -InstanceName "NewVSQLInstance"
...
function Set-SQLStartupParameters
{
	...
	.EXAMPLE 
		Set-SQLStartupParameters -InstanceName "NewVSQLInstance" -HostName $hostName -StartUpParameters -T2115,-T3226,-T1222
	.PARAMETER InstanceName
		The instance of sql server to configure
	.PARAMETER HostName
...
function Get-ProcessorCount
{
	...
	.EXAMPLE 
		Get-ProcessorCount -HostName "NewVSQLInstance"
	.PARAMETER HostName
...
function Get-MemoryCount
{
	...
	.EXAMPLE 
		Get-MemoryCount -HostName "NewVSQLInstance"
	.PARAMETER HostName
		The Hostname of the server the sql instance is installed on.
	#>
	[cmdletbinding()]
...
function Get-DiskSizeByLetter
{
	...
	.DESCRIPTION 
		Get the size of disk on a host by drive letter.
	.EXAMPLE 
		Get-DiskSizeByLetter -HostName "NewVSQLHost"
	.PARAMETER HostName
		The Hostname of the server the sql instance is installed on.
	.OUTPUT
...
Function Get-DatabaseFiles
{
	...
	.EXAMPLE 
		Get-DatabaseFiles -InstanceName "NewVSQLInstance" -DatabaseName "TempDB"
	.PARAMETER InstanceName
		The instance of sql server to configure
	.PARAMETER DatabaseName
...
Function Start-AllSQLConfgurationScripts
{
	<# 
	  ...
	  .DESCRIPTION 
		...
		enables database mail, enables always on, creates always on alerts, creates always on endpoints and permissions them, creats sp_help_revlogin and dependencies, 
	  .EXAMPLE 
		Start-AllSQLConfgurationScripts -InstanceName "NewVSQLInstance" -ConfigurationTSQLScriptsPath "C:\Temp\scripts\TSQLConfigurationScripts"
	  .PARAMETER InstanceName
		The instance of sql server to configure
...
<# 
  ...
  .DESCRIPTION 
	...
	enables database mail, enables always on, creates always on alerts, creates always on endpoints and permissions them, creats sp_help_revlogin and dependencies, 
  .EXAMPLE 
	New-SQLServerConfiguration -InstanceName "NewVSQLInstance"
  .PARAMETER InstanceName
	The instance of sql server to configure
#>
	[cmdletbinding()]
